    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow p-4 mt-4">
                <h3 className="text-lg font-semibold mb-2">Meal Distribution by Category</h3>
                <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                        <Pie data={data.categoryDistribution} dataKey="count" nameKey="_id" cx="50%" cy="50%" outerRadius={100}>
