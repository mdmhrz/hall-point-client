...
const AddMeal = () => {
    ...
    return (
        <>
            ...
            <div className="max-w-6xl mx-auto py-6 md:p-10 bg-gradient-to-tr from-base-100 via-base-200 to-base-100 shadow-2xl rounded-3xl mt-10 border border-base-300">
